"""add agents.prompt_fingerprint for L3b prompt-surface anti-copy detection

Revision ID: f7b4d5e31a92
Revises: e6a3c4d20f81
Create Date: 2026-07-07 18:00:00.000000

Adds the L3b prompt-surface channel to the anti-copy stack
...
share scaffolding prompts (the convergent case in ``ditto.anticopy.clonecal``),
