...
async def issue_confirmation_ticket(
    ...
    *,
    ...
    """Reissue this validator's ticket for one finalized challenger.
    ...
    submission on the ordinary lease-bound endpoint and requires no schema
    change.  A validator with unrelated live work receives no confirmation
