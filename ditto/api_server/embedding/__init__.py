"""L3c code-embedding client for the anti-copy gate (docs/SEMANTIC-CLONE-PREVENTION.md).
...
``L3C_EMBEDDER_URL`` is set), a best-effort ``Embedder`` that returns ``None`` on any
