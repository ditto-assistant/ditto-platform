"""Contract tests for the operator-configurable rescore cohort size."""
...
_URL = "/api/v1/admin/benchmark-rollout-settings"
_CONFIRMATION = "APPLY BENCHMARK ROLLOUT SETTINGS"
...
class TestDefaultAndRoundTrip:
    async def test_default_is_the_historical_ten_at_revision_zero(
        ...
        assert body["effective"]["min_rescore_cohort_size"] == 5
        assert body["effective"]["max_rescore_cohort_size"] == 25
